...
export default function SubmissionDeadlineBanner() {
  return (
    <div className="mt-2 rounded-xl border border-orange-500/30 bg-gradient-to-r from-orange-600/15 via-background to-orange-400/10 p-4 text-left shadow-lg shadow-orange-500/5 sm:mt-3 sm:p-5">
